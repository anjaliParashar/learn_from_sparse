...
i=5
x_ref,y_ref,_ = lane_change_trajectory(v=1.5,lane_width=1.7)
#yaw, risk_,x,y,cx,cy = do_simulation(v=data['Z_exp'][i][1],lane_width=data['Z_exp'][i][0])
yaw, risk_, mean_dist, max_dist, final, x,y,cx,cy = do_simulation(v=0.7,lane_width=1.7)
file_i = open("/home/anjali/learn_from_sparse/f1tenth/data/gpr/experiments/test_"+str(i)+".pkl",'wb')
data_i = {'X':y_ref,"Y":x_ref,"V_ref":0.7,'lw':1.7,'X_sim':x,'Y_sim':y}
